...
public class CalculatorDemo {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (!operation.equals("=") && !operation.equals("?") && !operation.equals("round") && !operation.equals("rand") && !operation.equals("inv") && !operation.equals("c") && !operation.equals("C") && !operation.equals("neg")) // don't get a number in these cases...
